...
<img src="https://capsule-render.vercel.app/api?type=waving&color=8d0fbf&height=280&section=header&text=NIRBHAYA&fontSize=95&fontAlignY=38&animation=twinkle&fontColor=fdfbf6&desc=Women%20Safety%20Intelligence%20%7C%20AI-Powered%20Real-Time%20Safety%20Shield&descAlignY=58&descSize=20" width="100%" />

<a href="https://github.com/rushikesh8877/NIRBHAYA-WOMEN_SAFETY_INTELLIGENCE">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=24&duration=2800&pause=900&color=B026FF&center=true&vCenter=true&width=780&lines=Protects+Before+Danger+Happens;AI+that+senses+trouble+before+you+do;One+tap.+Live+location.+Real+help.;From+Reaction+%E2%86%92+To+Prevention." alt="Typing SVG" />
</a>
...
[![Twitter](https://img.shields.io/badge/Share%20on-Twitter-1DA1F2?style=for-the-badge&logo=twitter&logoColor=white)](https://twitter.com/intent/tweet?text=Check%20out%20NIRBHAYA%20-%20an%20AI-powered%20women%20safety%20app!&url=https://github.com/rushikesh8877/NIRBHAYA-WOMEN_SAFETY_INTELLIGENCE)
[![LinkedIn](https://img.shields.io/badge/Share%20on-LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/sharing/share-offsite/?url=https://github.com/rushikesh8877/NIRBHAYA-WOMEN_SAFETY_INTELLIGENCE)
...
![XML](https://img.shields.io/badge/XML-Layouts-1a73e8?style=for-the-badge&logo=xml&logoColor=white)

### Backend

![Firebase](https://img.shields.io/badge/Firebase-FFCA28?style=for-the-badge&logo=firebase&logoColor=black)
![Realtime Database](https://img.shields.io/badge/Realtime%20Database-039BE5?style=for-the-badge&logo=firebase&logoColor=white)
![Firebase Auth](https://img.shields.io/badge/Firebase%20Auth-FFA000?style=for-the-badge&logo=firebase&logoColor=white)

### AI

![On-device AI](https://img.shields.io/badge/On--device%20AI-8d0fbf?style=for-the-badge&logo=tensorflow&logoColor=white)
![Anomaly Detection](https://img.shields.io/badge/Anomaly%20Detection-9d4edd?style=for-the-badge)
![Keyword Spotting](https://img.shields.io/badge/Keyword%20Spotting-c77dff?style=for-the-badge)
...
![Telephony API](https://img.shields.io/badge/Android%20Telephony%20API-3DDC84?style=for-the-badge&logo=android&logoColor=white)
![Sensor API](https://img.shields.io/badge/Sensor%20API-3DDC84?style=for-the-badge&logo=android&logoColor=white)

### Deployment

![Hosting](https://img.shields.io/badge/Web%20Hosting-Unaux-orange?style=for-the-badge)
...
```mermaid
flowchart TD
    A([👤 User]) --> B([📱 Frontend<br/>Android App])
    B --> C([⚙️ Backend<br/>Firebase])
    C --> D([🗄️ Database<br/>Realtime DB])
    C --> E([🌐 External APIs<br/>Maps · Telephony · Sensors])
    C --> F([🧠 AI Services<br/>Voice & Risk Detection])
    F --> G([🚨 Alert Dispatcher])
    G --> H([👥 Emergency Contacts])
    G --> I([💬 Offline SMS Gateway])

    style A fill:#8d0fbf,stroke:#8d0fbf,color:#fff
    style B fill:#9d4edd,stroke:#9d4edd,color:#fff
    style C fill:#c77dff,stroke:#c77dff,color:#1a1a1a
    style D fill:#e0aaff,stroke:#e0aaff,color:#1a1a1a
    style E fill:#c77dff,stroke:#c77dff,color:#1a1a1a
    style F fill:#8d0fbf,stroke:#8d0fbf,color:#fff
    style G fill:#ff5c8a,stroke:#ff5c8a,color:#fff
    style H fill:#9d4edd,stroke:#9d4edd,color:#fff
    style I fill:#9d4edd,stroke:#9d4edd,color:#fff
```
...
```mermaid
flowchart LR
    A([🚶 User in Risky Situation]) --> B{🧠 AI Detects Threat?}
    B -- Voice / Scream --> C([🚨 Auto Alert Triggered])
    B -- Shake / Drop --> C
    B -- Manual SOS Tap --> C
    C --> D([📍 Location Shared Instantly])
    D --> E([📞 Auto Call Placed])
    D --> F([💬 SMS Sent to Guardians])
    E --> G([✅ Help Arrives Faster])
    F --> G

    style A fill:#8d0fbf,stroke:#8d0fbf,color:#fff
    style B fill:#c77dff,stroke:#c77dff,color:#1a1a1a
    style C fill:#ff5c8a,stroke:#ff5c8a,color:#fff
    style D fill:#9d4edd,stroke:#9d4edd,color:#fff
    style E fill:#9d4edd,stroke:#9d4edd,color:#fff
    style F fill:#9d4edd,stroke:#9d4edd,color:#fff
...
![Android Studio](https://img.shields.io/badge/Android%20Studio-Latest-3DDC84?style=for-the-badge&logo=androidstudio&logoColor=white)
![JDK](https://img.shields.io/badge/JDK-11%2B-ED8B00?style=for-the-badge&logo=openjdk&logoColor=white)
![Firebase](https://img.shields.io/badge/Firebase%20Account-Required-FFCA28?style=for-the-badge&logo=firebase&logoColor=black)
...
<table>
<tr>
<td align="center"><b>Home Screen</b><br/><img src="docs/images/home.png" width="220"/></td>
<td align="center"><b>AI Safety Hub</b><br/><img src="docs/images/ai_safety_hub.png" width="220"/></td>
<td align="center"><b>Settings</b><br/><img src="docs/images/settings.png" width="220"/></td>
</tr>
<tr>
<td align="center"><b>voice-Detection</b><br/><img src="docs/images/voice-Detection.png" width="220"/></td>
<td align="center"><b>Area-Analysis </b><br/><img src="docs/images/Area-Analysis.png" width="220"/></td>
<td align="center"><b>Live Location Tracking</b><br/><img src="docs/images/live_location.png" width="220"/></td>
</tr>
</table>
...
<td align="center" width="25%">
  <img src="https://api.dicebear.com/7.x/initials/svg?seed=Dibyaranjan%20Samal&backgroundColor=9d4edd"
       width="100"
       style="border-radius:50%"/>
  <br/>
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=8d0fbf&height=150&section=footer" width="100%"/>
